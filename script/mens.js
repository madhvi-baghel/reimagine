...
function appendCards() {
  ...
  const cardData = [
    ...
    {
      imageSrc: "img/products/f2.jpg",
      altText: "Product 2",
      title: "Space Explorer T-Shirts",
      price: "$85",
    },
    {
      imageSrc: "img/products/f3.jpg",
      altText: "Product 1",
      title: "Cartoon Astronaut T-Shirts",
      price: "$78",
    },
    {
      imageSrc: "img/products/f4.jpg",
      altText: "Product 2",
      title: "Space Explorer T-Shirts",
      price: "$85",
    },
    {
      imageSrc: "img/products/f5.jpg",
      altText: "Product 1",
      title: "Cartoon Astronaut T-Shirts",
      price: "$78",
    },
    {
      imageSrc: "img/products/f6.jpg",
      altText: "Product 2",
      title: "Space Explorer T-Shirts",
      price: "$85",
    },
    {
      imageSrc: "img/products/f7.jpg",
      altText: "Product 1",
      title: "Cartoon Astronaut T-Shirts",
      price: "$78",
    },
    {
      imageSrc: "img/products/f8.jpg",
      altText: "Product 2",
      title: "Space Explorer T-Shirts",
      price: "$85",
    },
